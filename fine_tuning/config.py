...
CONFIGS = [
    ...
    {"name": "high_lr",     "lr": 5e-5, "batch": 16, "epochs": 3, "wd": 0.01}, #imparare più velocemente migliora o peggiora i risultati? 
    {"name": "more_epochs", "lr": 2e-5, "batch": 16, "epochs": 5, "wd": 0.01}, #più tempo al modello migliora i risultati o overfitting?
    {"name": "small_batch", "lr": 2e-5, "batch": 8,  "epochs": 3, "wd": 0.01}, #aggiornare i pesi più spesso cambia qualcosa?
]
